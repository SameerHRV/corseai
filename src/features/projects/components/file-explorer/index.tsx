...
const FileExplorer = ({ projectId }: { projectId: Id<"projects"> }) => {
  ...
  const handleCreateFile = (inputName: string) => {
    setCreating(null);
    setName("");
    ...
    <div className="h-full bg-sidebar">
      <ScrollArea>
        <div
          ...
          className="w-full group/project cursor-pointer flex items-center text-left gap-0.5 h-5.5 bg-accent font-bold"
        >
          <ChevronRightIcon
            className={cn(
          ...
          <>
            ...
            {creating && (
              <CreateInput
                type={creating}
                level={0}
                onSubmit={(inputName) => handleCreateFile(inputName)}
