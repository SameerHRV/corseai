...
const ProjectItem = ({ data }: { data: Doc<"projects"> }) => {
  return (
    <Link
      ...
      className="text-sm font-medium text-foreground/60 hover:text-foreground py-1 flex items-center justify-between w-full group"
    >
      <div className="flex items-center gap-2">
        {getProjectIcon(data)}
...
const ProjectList = ({ onViewAll }: ProjectListProp) => {
